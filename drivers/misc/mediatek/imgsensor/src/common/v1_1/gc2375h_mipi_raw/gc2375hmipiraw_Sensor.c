...
#include "gc2375hmipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .linelength = 1280,                //record different mode's linelength
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] =
{
    ...
    { 1600, 1200,    0,    0, 1600, 1200, 1600,  1200, 0000, 0000, 1600,  1200,      0,    0, 1600,  1200}, // 24fps dual camera Cong.Zhou@
};// slim video
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0x23,0x19);
    write_cmos_sensor(0x24,0x02);
    write_cmos_sensor(0x25,0x13);
    write_cmos_sensor(0x26,0x08);
    write_cmos_sensor(0x29,0x04);//change HS timeing for pass1 dequeue fail ;origin value is 06
    write_cmos_sensor(0x2a,0x07);//change HS timeing for pass1 dequeue fail ;origin value is 08
...
kal_uint16 get_byte=0;
    ...
    iReadRegI2C(pusendcmd , 2, (u8*)&get_byte, 1, 0xA5/*EEPROM_READ_ID*/);
    if (get_byte == 0) {
        iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, 0xA5/*EEPROM_READ_ID*/);
    }
    return get_byte;
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if (deviceInfo_register_value == 0x00) {
                    if (check_eeprom_awb_golden(*sensor_id, 0xA5)) {
                        sprintf(sensor_name_golden_result, "%s_1", DEVICE_VERSION_GC2375H);
                    } else {
                        sprintf(sensor_name_golden_result, "%s_0", DEVICE_VERSION_GC2375H);
                    }
                    register_imgsensor_deviceinfo("Cam_r2", sensor_name_golden_result, imgsensor_info.module_id);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
            ...
            *feature_para_len=4;
            break;
        /* Houbing.Peng@ODM_HQ Cam.Drv 20191111 add for support SWNR */
